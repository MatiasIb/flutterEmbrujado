...
class FormularioEditarNoticia extends StatefulWidget {
  ...
  final Noticia? noticia;
  @override
  _FormularioEditarNoticiaState createState() =>
      _FormularioEditarNoticiaState(noticia);
}

class _FormularioEditarNoticiaState extends State<FormularioEditarNoticia> {
  final Noticia? noticia;
  String? title;
  String? body;
  String? baseImage;
  ...
  _FormularioEditarNoticiaState(this.noticia);
  ...
  Widget inputs() {
    return Inputs(
      titleValue: noticia!.title,
      title: ((value) {
        setState(() {
          title = value;
        });
      }),
      bodyValue: noticia!.body,
      body: (value) {
        setState(() {
          body = value;
        });
  ...
  Widget boton(IngresarNoticiaState state) {
    return BotonEditar(
        ...
        title: title,
        body: body,
        imagen: baseImage == null ? noticia!.mainImage : baseImage);
  }
