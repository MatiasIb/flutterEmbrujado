...
class FormularioAgregarNoticia extends StatefulWidget {
  ...
  @override
  FormularioAgregarNoticiaState createState() =>
      FormularioAgregarNoticiaState();
}

class FormularioAgregarNoticiaState extends State<FormularioAgregarNoticia> {
  String? title;
  String? body;
  String? baseImage;
  File? _image;
  ...
  Future pickImage() async {
    try {
      ...
      print('Fallo al seleccionar la imagen: $_');
    }
  }
